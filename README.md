...
![version](https://img.shields.io/badge/version-1.14.3-6750A4)
![platform](https://img.shields.io/badge/Android-7.0%2B-34A853)
![apk](https://img.shields.io/badge/APK-336_KB-4285F4)
...
| 站内点赞（全站计数）与自建歌单 | — | ✅ |
| 猜你喜欢（基于点赞歌手） | — | ✅ |
| **扫码绑定自己的网易云账号**：全量歌单同步（实测 31 张 / 3791 首）、发评论、点赞回复、红心歌曲 | — | ✅ |
...
- **在线更新**：启动自动检测新版本并弹窗提示 · **服务器直连 / GitHub Releases 双下载源**（进弹窗自动测速、优选最快源、可手动切换）· 应用内下载进度 · 完成后自动拉起系统安装器
