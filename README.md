...
![version](https://img.shields.io/badge/version-1.20.0-6750A4)
...
- **头像挂件**：累计听歌时长满 **2 小时**解锁，**402 款**可选并支持按名称/ID 搜索；设置后个人主页、发现页广场、听歌房**全局公开显示**（素材按实测留白逐款补偿，圆环恰好包裹头像）
...
- **网页版**：登录页/设置页「下载安卓版 APP」入口（`/cm/download/latest` 稳定直链最新包）
